@echo off
:: Generated on 2024-11-14 13:30:57 GMT
...
:START_PROCESS
title 26100.2314_amd64_zh-cn_multi_6a331068 download
...
"%aria2%" --no-conf --async-dns=false --console-log-level=warn --log-level=info --log="aria2_download.log" -o"%aria2Script%" --allow-overwrite=true --auto-file-renaming=false "https://uupdump.net/get.php?id=6a331068-30d4-484b-be3b-1456d9296496&pack=neutral&edition=app&aria2=2"
...
"%aria2%" --no-conf --async-dns=false --console-log-level=warn --log-level=info --log="aria2_download.log" -o"%aria2Script%" --allow-overwrite=true --auto-file-renaming=false "https://uupdump.net/get.php?id=6a331068-30d4-484b-be3b-1456d9296496&pack=zh-cn&edition=professional;core&aria2=2"
if %ERRORLEVEL% GTR 0 call :DOWNLOAD_ERROR & exit /b 1
echo.
